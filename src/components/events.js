        ...
        <div className="event-container">
            ...
            <div className="event-group">
                <div className="event-section">
                    ...
                    <img className="event-img" src="/assets/birthday-event.jpg" alt="event-img"/>
                ...
                <div className="event-section">
                    ...
                    <img className="event-img" src="/assets/team-bonding.jpg" alt="event-img"/>
                ...
                <div className="event-section">
                    ...
                    <img className="event-img" src="/assets/play-date.jpg" alt="event-img"/>

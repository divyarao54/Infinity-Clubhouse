        ...
        <div className="event-container">
            ...
            <div className="event-group">
                <div className="event-section">
                    <div className="event-title" style={{color: "lightblue"}}>Birthday Bashes!</div>
                ...
                <div className="event-section">
                    <div className="event-title" style={{color: "lightgoldenrodyellow"}}>Club-Events!</div>
                ...
                <div className="event-section">
                    <div className="event-title" style={{color: "lightpink"}}>Play Dates!</div>
